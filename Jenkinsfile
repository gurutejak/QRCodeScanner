...
node{
    ...
    steps {
    script{
    hockeyApp applications: [[apiToken: '743d568b06a24060bb548614c1bcf4ad', downloadAllowed: true, filePath: '**/QRReader-D192754D-F475-4B80-A328-964F07E60523.ipa', mandatory: false, notifyTeam: true, releaseNotesMethod: none(), uploadMethod: appCreation(false)]], debugMode: false, failGracefully: false
            }
        }
    }
