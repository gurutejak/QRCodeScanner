...
node{
    ...
    stage('stg ipa') {
        ...
        sh "xcodebuild -exportArchive -archivePath -exportOptionsPlist= '/Users/tejaketepalle/.jenkins/workspace/pline_JenkinsPipelineScript-TPWC2KQLFWO6EJ5NDZURGX7PLOFMIWJR4VH26YMQ64H55STRBSQA/ExportOptions.plist'"
    }
}
